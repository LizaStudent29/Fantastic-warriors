...
// import './Player.js';
// const { Warrior, Archer } = require('./Entities/Player.js').default;
...
// Реализация базового класса Weapon и его наследников
// Реализация базового класса Player и его наследников
// Логика движения, боя и игрового хода
// Функция play()
